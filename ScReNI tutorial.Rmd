...
source('R/Integrate_scRNA_scATAC.R')
...
source('R/Plot_integrated_scRNA_scATAC.R')
...
source('R/Get_scRNA_scATAC_neighbors.R')
...
source('r/Select_partial_cells_for_scNewtorks.R')
# partial cells
...
source('R/wScReNI_affiliated_functions.R')
source('R/Infer_gene_peak_relationships.R')
source('R/Integrate_scRNA_scATAC.R')
source('R/Infer_wScReNI_scNetworks.R')
source('R/Combine_wScReNI_scNetworks.R')
...
source('R/Precision_recall_affiliated_functions.R')
source('R/Calculate_scNetwork_precision_recall.R')
source('R/Calculate_scNetwork_precision_recall_top.R')
source('R/Plot_scNetwork_precision_recall.R'))
...
source('R/Calculate_scNetwork_degree.R')
...
# source('R/Plot_scNetwork_clustering.R')
...
for(i in 1:length(scNetworks_degree)){
  ...
  outdegree_heatmap <- Heatmap(cor(log(outdegree+1)), 
